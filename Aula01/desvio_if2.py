...
# Se o aluno tiver uma média acima ou igual a 7, então estará APROVADO.
# Senão se a média for abaixo ou igual a 4, então estará REPROVADO caso contrário, estrará em RECUPERAÇÃO
